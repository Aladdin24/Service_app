...
import 'package:projet/pages/notification.dart';

class commandeEt extends StatefulWidget {
  ...
  @override
  _commandeEtState createState() => _commandeEtState(
...
class _commandeEtState extends State<commandeEt> {
  final int id_entreprise;
  final String Nom_ent;
  // final String id_categorie;
  final String photo;
  ...
  Future upload() async {
    ...
    request.fields['Nom_commande'] = 'Electrien';
